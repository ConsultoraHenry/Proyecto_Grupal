#############################################################
## Programa     :   checkinBusiness_extraccion-carga
## Fecha        :   Marzo 14; 2023
## Autor        :   grupo4
...
folder_id = '1e27q1-_ecuzGjFC1gtRXoYcZqv1NBie1'
query = f"'{folder_id}' in parents and trashed = false and name = 'business_y_checkin.json'"
